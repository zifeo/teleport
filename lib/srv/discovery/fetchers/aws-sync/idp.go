...
func (a *awsFetcher) pollAWSSAMLProviders(ctx context.Context, result, existing *Resources, collectErr func(error)) func() error {
	return func() error {
		var err error
...
func (a *awsFetcher) pollAWSOIDCProviders(ctx context.Context, result, existing *Resources, collectErr func(error)) func() error {
	return func() error {
		var err error
