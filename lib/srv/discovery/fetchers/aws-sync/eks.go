...
func (a *awsFetcher) pollAWSEKSClusters(ctx context.Context, result, existing *Resources, collectErr func(error)) func() error {
	return func() error {
		output, err := a.fetchAWSSEKSClusters(ctx, existing)
		if err != nil {
...
func (a *awsFetcher) fetchAWSSEKSClusters(ctx context.Context, existing *Resources) (fetchAWSEKSClustersOutput, error) {
	var (
