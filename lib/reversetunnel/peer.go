...
func (p *clusterPeers) DialAuthServer(reversetunnelapi.DialParams) (net.Conn, error) {
...
func (p *clusterPeers) Dial(params reversetunnelapi.DialParams) (conn net.Conn, err error) {
	return p.DialTCP(params)
}

func (p *clusterPeers) DialTCP(params reversetunnelapi.DialParams) (conn net.Conn, err error) {
...
// located in a remote connected site, the connection goes through the
// reverse proxy tunnel.
func (s *clusterPeer) Dial(params reversetunnelapi.DialParams) (conn net.Conn, err error) {
