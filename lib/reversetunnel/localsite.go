...
func (s *localSite) DialAuthServer(params reversetunnelapi.DialParams) (net.Conn, error) {
...
func shouldDialAndForward(params reversetunnelapi.DialParams, recConfig types.SessionRecordingConfig) bool {
...
func (s *localSite) Dial(params reversetunnelapi.DialParams) (net.Conn, error) {
...
func (s *localSite) maybeSendSignedPROXYHeader(params reversetunnelapi.DialParams, conn net.Conn, useTunnel, checkVersion bool) error {
...
func (s *localSite) DialTCP(params reversetunnelapi.DialParams) (net.Conn, error) {
...
func (s *localSite) dialAndForward(params reversetunnelapi.DialParams) (_ net.Conn, retErr error) {
...
// a peer proxy.
func (s *localSite) tryProxyPeering(params reversetunnelapi.DialParams) bool {
	if s.peerClient == nil {
		return false
	}
	if params.FromPeerProxy {
...
func (s *localSite) skipDirectDial(params reversetunnelapi.DialParams) (bool, error) {
...
func getTunnelErrorMessage(params reversetunnelapi.DialParams, connStr string, err error) string {
...
func (s *localSite) getConn(params reversetunnelapi.DialParams) (conn net.Conn, useTunnel bool, err error) {
