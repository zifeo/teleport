...
*/
func (h *Handler) signDatabaseCertificate(w http.ResponseWriter, r *http.Request, p httprouter.Params, site reversetunnelapi.RemoteSite, token types.ProvisionToken) (interface{}, error) {
