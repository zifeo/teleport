...
type SessionContextConfig struct {
	...
	newRemoteClient func(ctx context.Context, sessionContext *SessionContext, site reversetunnelapi.RemoteSite) (auth.ClientI, error)
}
...
// returned.
func (c *SessionContext) GetUserClient(ctx context.Context, site reversetunnelapi.RemoteSite) (auth.ClientI, error) {
...
func (c *SessionContext) remoteClient(ctx context.Context, site reversetunnelapi.RemoteSite) (auth.ClientI, error) {
...
func newRemoteClient(ctx context.Context, sctx *SessionContext, site reversetunnelapi.RemoteSite) (auth.ClientI, error) {
...
func clusterDialer(remoteCluster reversetunnelapi.RemoteSite, src, dst net.Addr) apiclient.ContextDialer {
	return apiclient.ContextDialerFunc(func(in context.Context, network, _ string) (net.Conn, error) {
		dialParams := reversetunnelapi.DialParams{
			From:                  src,
...
func (c *SessionContext) newRemoteTLSClient(ctx context.Context, cluster reversetunnelapi.RemoteSite) (auth.ClientI, error) {
...
func (c *remoteClientCache) addRemoteClient(site reversetunnelapi.RemoteSite, remoteClient auth.ClientI) error {
	c.Lock()
	defer c.Unlock()
	if c.clients == nil {
...
func (c *remoteClientCache) getRemoteClient(site reversetunnelapi.RemoteSite) (auth.ClientI, bool) {
	c.Lock()
	defer c.Unlock()
