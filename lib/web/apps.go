...
func (h *Handler) clusterAppsGet(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
func (h *Handler) resolveApp(ctx context.Context, clt app.Getter, proxy reversetunnelapi.Tunnel, params resolveAppParams) (*resolveAppResult, error) {
	var (
...
func (h *Handler) resolveDirect(ctx context.Context, proxy reversetunnelapi.Tunnel, publicAddr string, clusterName string) (types.AppServer, string, error) {
...
func (h *Handler) resolveFQDN(ctx context.Context, clt app.Getter, proxy reversetunnelapi.Tunnel, fqdn string) (types.AppServer, string, error) {
