...
func (h *Handler) handleDatabaseCreate(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
func (h *Handler) handleDatabaseUpdate(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
func (h *Handler) handleDatabaseGetIAMPolicy(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
	databaseName := p.ByName("database")
	if databaseName == "" {
