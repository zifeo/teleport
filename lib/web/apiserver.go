...
func (h *Handler) getUserContext(w http.ResponseWriter, r *http.Request, p httprouter.Params, c *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
func (h *Handler) getSiteNamespaces(w http.ResponseWriter, r *http.Request, _ httprouter.Params, c *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
func (h *Handler) clusterNodesGet(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
func (h *Handler) clusterLoginAlertsGet(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
	// Get a client to the Auth Server with the logged in user's identity. The
...
func (h *Handler) clusterActiveAndPendingSessionsGet(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
	clt, err := sctx.GetUserClient(r.Context(), site)
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (h *Handler) clusterSearchEvents(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
	values := r.URL.Query()
...
//	            for ascending and descending respectively.
//	            If no order is provided it defaults to descending.
func (h *Handler) clusterSearchSessionEvents(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
// searchEvents method.
func clusterEventsList(ctx context.Context, sctx *SessionContext, site reversetunnelapi.RemoteSite, values url.Values, searchEvents func(clt auth.ClientI, from, to time.Time, limit int, order types.EventOrder, startKey string) ([]apievents.AuditEvent, string, error)) (interface{}, error) {
...
//
// {"events": [{...}, {...}, ...}
func (h *Handler) siteSessionEventsGet(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
...
type ClusterHandler func(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error)
...
func (h *Handler) authenticateRequestWithCluster(w http.ResponseWriter, r *http.Request, p httprouter.Params) (*SessionContext, reversetunnelapi.RemoteSite, error) {
...
// remote trusted cluster) as specified by the ":site" url parameter.
func (h *Handler) getSiteByParams(sctx *SessionContext, p httprouter.Params) (reversetunnelapi.RemoteSite, error) {
...
func (h *Handler) getSiteByClusterName(ctx *SessionContext, clusterName string) (reversetunnelapi.RemoteSite, error) {
...
type ProvisionTokenHandler func(w http.ResponseWriter, r *http.Request, p httprouter.Params, site reversetunnelapi.RemoteSite, token types.ProvisionToken) (interface{}, error)
...
// of the given user.
func (h *Handler) ProxyWithRoles(ctx *SessionContext) (reversetunnelapi.Tunnel, error) {
	...
	return reversetunnelapi.NewTunnelWithRoles(h.cfg.Proxy, cn.GetClusterName(), accessChecker, h.cfg.AccessPoint), nil
}
