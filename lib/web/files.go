...
func (h *Handler) transferFile(w http.ResponseWriter, r *http.Request, p httprouter.Params, sctx *SessionContext, site reversetunnelapi.RemoteSite) (interface{}, error) {
	query := r.URL.Query()
