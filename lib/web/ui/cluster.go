...
func NewClusters(remoteClusters []reversetunnelapi.RemoteSite) ([]Cluster, error) {
...
func GetClusterDetails(ctx context.Context, site reversetunnelapi.RemoteSite, opts ...services.MarshalOption) (*Cluster, error) {
