...
func MatchHealthy(proxyClient reversetunnelapi.Tunnel, clusterName string) Matcher {
...
func ResolveFQDN(ctx context.Context, clt Getter, tunnel reversetunnelapi.Tunnel, proxyDNSNames []string, fqdn string) (types.AppServer, string, error) {
