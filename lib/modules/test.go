...
func (m *TestModules) AttestHardwareKey(ctx context.Context, obj any, policy keys.PrivateKeyPolicy, as *keys.AttestationStatement, pk crypto.PublicKey, d time.Duration) (keys.PrivateKeyPolicy, error) {
