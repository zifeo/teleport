...
- `<cluster>` - the name of the cluster,  see [Trusted Cluster](../../admin-guides/management/admin/trustedclusters.mdx) for more information.
...
through Teleport.  See the [OpenSSH Guide](../../enroll-resources/server-access/guides/openssh/openssh.mdx) guide
