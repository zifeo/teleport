...
infrastructure changes using infrastructure as code tools.
...
- To see the dynamic configuration resources available to apply, read the
  ...
  [applications](../enroll-resources/application-access/reference.mdx#application-resource) and
  [databases](../enroll-resources/database-access/reference/configuration.mdx#database-resource).
